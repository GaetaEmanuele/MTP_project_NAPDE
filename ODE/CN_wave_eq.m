function [U,V]=CN_wave_eq(Dati,x,dependence,Matrix,list_U ,list_V,front,t_hat)
    ...
    for n = 1:num_steps-1
        ...
        A = M + 0.5* dt*(Sigma-I);
        Matrices = compute_matrix1(Dati,Matrix,front,x,ti);
        M = Matrices.M;
        Sigma = Matrices.Sigma;
        B = M - 0.5*dt*(Sigma-I);
